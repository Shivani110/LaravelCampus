                                ...
                                <li class="nk-menu-item has-sub active">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/alumni-dashboard/alumni/') }}" class="nk-menu-link"><span class="nk-menu-text">Add Alumni</span></a>
                                        </li>
                                        <!-- <li class="nk-menu-item">
                        ...
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img" src="" srcset="" alt="Campus">
                                     ...
                                     <li class="dropdown user-dropdown">
                                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-avatar sm">
                                                    <img src="{{ asset('/images/'.$alumni->pictures) }}">
                                                </div>
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status">Alumni</div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="{{ url('alumni-dashboard/profile') }}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                                    <li><a href="{{ url('alumni-dashboard/accountsetting') }}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
