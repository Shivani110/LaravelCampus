                                ...
                                <li class="nk-menu-item has-sub active">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/sponsor-dashboard/sponsor/') }}" class="nk-menu-link"><span class="nk-menu-text">Add Sponsor</span></a>
                                        </li>
                                        <!-- <li class="nk-menu-item">
                                     ...
                                     <li class="dropdown user-dropdown">
                                            ...
                                            <div class="user-toggle">
                                                <div class="user-avatar sm">
                                                    <?php 
                                                        ...
                                                        $user = Auth::user();
                                                        $sponsor = (App\Models\Sponsor::where('user_id','=',Auth::user()->id)->first());
                                                    ?>
                                                    <img src="{{ asset('/images/'.$sponsor->pictures) }}">
                                                </div>
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status">Sponsor</div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    <div class="user-avatar">
                                                        <span><img src="{{ asset('/images/'.$sponsor->pictures) }}"></span>
                                                    </div>
                                                    <div class="user-info">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="{{ url('sponsor-dashboard/profile') }}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                                    <li><a href="{{ url('sponsor-dashboard/accountsetting') }}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
