                                                ...
                                                <div class="between-center flex-wrap g-3">
                                                    ...
                                                    <div class="nk-block-actions flex-shrink-sm-0">
                                                        <ul class="align-center flex-wrap flex-sm-nowrap gx-3 gy-2">
                                                            <li class="order-md-last">
                                                                <a href="{{ url('alumni-dashboard/changepassword') }}" class="btn btn-primary">Change Password</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-inner-group">
                                    ...
                                    <div class="card-inner p-0">
                                        <ul class="link-list-menu">
                                            <li><a href="{{ url('alumni-dashboard/profile') }}"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                                            ...
                                            <li><a class="active" href="{{ url('alumni-dashboard/accountsetting') }}"><em class="icon ni ni-lock-alt-fill"></em><span>Security Settings</span></a></li>
