                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                              ...
                              @if ($message = Session::get('success'))
                                ...
                                <form action="{{ url('signin') }}" class="form-validate is-alter" autocomplete="off" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input autocomplete="off" type="text" class="form-control form-control-lg" required id="email" name="email" placeholder="Enter your email address or username">
                                        </div>
                                    </div><!-- .form-group -->
                                    <div class="form-group">
                                        <div class="form-label-group">
                                ...
                                <div class="text-center mt-5">
                                    <span class="fw-500">LogOut? <a href="{{ url('logout') }}">Logout</a></span>
                                </div>
                            </div><!-- .nk-block -->
